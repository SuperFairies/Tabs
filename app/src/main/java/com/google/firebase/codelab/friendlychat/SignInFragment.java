   ...
   public View onCreateView(LayoutInflater inflater,
    ...
    private void handleFirebaseAuthResult(AuthResult authResult) {
        if (authResult != null) {
            ...
            Toast.makeText(this.getActivity(), "Welcome " + user.getEmail(), Toast.LENGTH_SHORT).show();

            // Go back to the main activity
            startActivity(new Intent(this.getActivity(), ChatFragment.class));
        }
    }
                ...
                .addOnCompleteListener(this.getActivity(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(SignInFragment.this.getActivity(), "Authentication failed.",
